...
/*
Um jeito fácil de ver se a sua variável local vai gerar um erro de compilação, é se perguntar se você pode qualificar
a variável pelo tipo da classe ou pelas palaveas this ou super, etc. Se você não puder, então ela já foi definida em
um escopo externo e vai causar um erro.
 */
public class Person {
